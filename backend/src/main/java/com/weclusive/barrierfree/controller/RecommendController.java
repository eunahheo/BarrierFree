...
public class RecommendController {
	...
	public ResponseEntity<Object> getImpairment(
			@RequestParam @ApiParam(value = "관광공사 API에 존재하는 컨텐츠id") long contentid) {
	...
	public ResponseEntity<Object> getSearchListByLoc(
			@RequestParam @ApiParam(value = "현재 로그인중인 사용자의 userSeq") int userSeq,
