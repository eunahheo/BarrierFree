...
@Repository
public interface AlarmRepository extends JpaRepository<Comment, Long> {

	// 확인 안하고 삭제 안된 알람 조회
	@Query(value = "SELECT a FROM Alarm a WHERE a.delYn = 'n' AND a.checkYn = 'n' AND a.alarmType = ?1 AND a.userSeq = ?2 ")
